...
insert into AppSettings
    (BrandName,HeroTitle,HeroSubTitle,HeroImageUrl,AboutText,AboutImageUrl,SkillsImageUrl,AddressText,AddressDistrict,AddressCity,PhoneNumber,Email,GoogleMap)
values
    (
        'Kemal Kodyazar',
        'Backend Developer',
