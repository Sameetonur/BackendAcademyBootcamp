...
CREATE NONCLUSTERED INDEX IX_Products_CategoryId on Products(CategoryId);
 --arama işlemlerini daha hızlı yapıyor olucak burada products tablsonda aramaycak gidip category tablosunda daha hızlı bir arama yaparak veriyi bize getiricek
...
--Sales
CREATE NONCLUSTERED INDEX IX_Products_ProductId on Sales(ProductId);
CREATE NONCLUSTERED INDEX IX_Products_CustomerId on Sales(CustomerId);
CREATE NONCLUSTERED INDEX IX_Products_SaleDate on Sales(SaleDate);


--StockTransactions
CREATE NONCLUSTERED INDEX IX_Products_ProductId on StockTransactions(ProductId);
CREATE NONCLUSTERED INDEX IX_Products_TransactionDate on StockTransactions(TransactionDate);
CREATE NONCLUSTERED INDEX IX_Products_TransactionTypeId on StockTransactions(TransactionTypeId);
