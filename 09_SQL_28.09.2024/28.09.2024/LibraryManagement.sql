...
(
    ItemId INT PRIMARY KEY,
    IssueNumber NVARCHAR(100) NOT NULL,
    FOREIGN KEY (ItemId) REFERENCES LibraryItems(Id)
)
GO
CREATE TABLE DVDs
...
(
    ...
    MambershipStatus NVARCHAR(50) NOT NULL,
)
GO
...
(
    ...
    FOREIGN KEY (MemberId) REFERENCES Members(Id),
    FOREIGN KEY (ItemId) REFERENCES LibraryItems(Id),
    CHECK (RetrunDate IS NULL OR RetrunDate>BorrowDate)
)
GO
...
INSERT INTO Borrowings
    (MemberId, ItemId, BorrowDate, RetrunDate)
VALUES
